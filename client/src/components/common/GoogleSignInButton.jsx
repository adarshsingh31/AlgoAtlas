 ...
 *
 * A reusable "Continue with Google" button for AlgoAtlas.
 * Adapted from VendorHub — uses the transparent overlay technique:
 *   1. Renders a custom-styled visible button.
 *   2. Overlays a transparent <GoogleLogin> on top.
 *   3. When clicked, Google's handler fires and returns a credential (ID token).
 *   4. We forward that credential to the parent via the onSuccess prop.
 *
 * Props:
...
function GoogleLogo() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" style={{ width: 18, height: 18, flexShrink: 0 }}>
